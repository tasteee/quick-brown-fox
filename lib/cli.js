...
const HELP = `
${log.c.magenta(log.c.bold('quick-brown-fox'))} - run a normal web app as a desktop app.
...
${log.c.bold('Arguments')}
  entry            Path to your entry file or source folder.
                   Defaults to source/main.tsx (then common fallbacks).

${log.c.bold('Options')}
  -e, --entry <path>     Entry file or folder (alternative to positional arg)
      --framework <name> UI framework: react, solid, vue, svelte, vanilla
...
${log.c.bold('Example')}
  ...
  {
    "scripts": {
      "dev": "qbf dev source/main.tsx",
      "build": "qbf build source/main.tsx"
    },
    "qbf": {
      "framework": "solid"
    }
